...
Blockly.Arduino["joystick_setup"] = function() {
    Blockly.Arduino.setups_.setup_input_3 = "  for (int i = 0; i < 2; i++) {\n" + "     pinMode(3, INPUT);\n" + "  }\n" + "  Serial.begin(115200);\n";
    return ""
};

Blockly.Arduino['up'] = function(block) {
    var code = 'x >10';
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.Arduino.ORDER_NONE];
};

Blockly.Arduino['down'] = function(block) {
    var code = 'x <-10';
    // TODO: Change ORDER_NONE to the correct strength.
    return [code, Blockly.Arduino.ORDER_NONE];
};
...
Blockly.Arduino['p_up'] = function(block) {
    // TODO: Assemble Arduino into code variable.
    var code = 'Serial.println("w");\n';
    return code;
};

Blockly.Arduino['p_down'] = function(block) {
    // TODO: Assemble Arduino into code variable.
    var code = 'Serial.println("s");';
    return code;
};
...
Blockly.Arduino['input'] = function(block) {
    // TODO: Assemble Arduino into code variable.
    var code = '  int x = analogRead(A0) - 507;\n' + '  int y = analogRead(A1) - 509;\n';
    return code;
};
...
//cd C:\xampp\htdocs\BlocklyDuino-gh-pages
